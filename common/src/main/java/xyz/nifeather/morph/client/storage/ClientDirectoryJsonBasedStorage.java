...
public abstract class ClientDirectoryJsonBasedStorage<T> extends MorphClientObject
{
    ...
    public void setPackageVersion(int version)
    {
        ...
        var file = clientDirectoryStorage.getFile("package_version.txt", true);
    ...
    public int getPackageVersion()
    {
        ...
        var file = clientDirectoryStorage.getFile("package_version.txt", false);
    ...
    {
        var root = clientDirectoryStorage.getRootDirectory();
